...
class DetailStarship extends StatelessWidget {
  final StarshipResponse detail;

  const DetailStarship({Key key, this.detail}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      // each product have a color
      backgroundColor: mainBg,
      appBar: AppBarCustom(context: context, title: "Detail Starship"),
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  LabelContent(
                      ...
                      value: detail.hyperdriveRating),
                  LabelContent(title: "Length", value: detail.length),
                  LabelContent(title: "MGLT", value: detail.mGLT),
                  LabelContent(
                  ...
                  LabelContent(
                      title: "Starship Class", value: detail.starshipClass),
                ],
              ),
            ),
          ],
